...
=== :create Create an attachable EBS Volume Instance
...
=== :attach Attach an EBS Volume Instance to the current EC2 instance
...
=== :detatch Detach an EBS Volume Instance from current EC2 Instance
...
=== :snapshot Create an EBS snapshot of EBS Volume
...
=== :associate Associate an Elastic IP to the Currrent EC2 instance
...
=== :disassociate Disassociate an Elastic IP to this instance
