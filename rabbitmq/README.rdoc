...
* :version				The Mercurual Tag or Branch to use for rabbitmq (defaults to "default" which is the latest qa'd branch)

== rabbitmq[:stomp]

* :version				The Mercurual Tag or Branch to use for rabbitmq-stomp adapter (defaults to "default")
